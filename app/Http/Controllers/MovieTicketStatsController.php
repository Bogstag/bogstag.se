...
class MovieTicketStatsController extends Controller
{
    ...
    public function index()
    {
        ...
        $LineChartAverageTicketPricePerYear = $this->getLineChartAverageTicketPricePerYear($TicketsPerYear->map(function (Movie $item) {
        ...
        $BarChartNumberOfTicketsPerYear = $this->getBarChartNumberOfTicketsPerYear($TicketsPerYear->map(function (Movie $item) {
